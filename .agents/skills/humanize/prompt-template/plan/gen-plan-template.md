...
- `coding`: implemented by the current Codex session
- `analyze`: independently reviewed through `scripts/ask-codex.sh`
...
- Planner: <actual session model, or unknown>
- Reviewer: <model confirmed by ask-codex metadata>
- Evidence: <project-relative paths to saved reviewer input/output/metadata>

### Agreements
- <Point both sides agree on>

### Resolved Disagreements
- <Topic>: planner and reviewer positions, chosen resolution, and rationale
